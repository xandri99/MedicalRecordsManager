...
class StatisticsLayout(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        super(StatisticsLayout, self).__init__(*args, **kwargs)
        ...
        # Create our DataFrame with the data from the databases.
        # MANUEL - SANTI
        ...
        patients_per_month.plot(ax = sc.axes, title = 'Patients attended each month', ylabel = 'Nº of Patients').set_xticklabels(['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'])
        

        inventory.plot.bar(ax = sc2.axes, title = 'Inventory', ylabel = 'Nº of units used').set_xticklabels(['Gasas', 'Anestesia', 'Gomas', 'Braquets'])
        
        
        patologies.plot.pie(y='mass', ax = sc3.axes, figsize=(5, 5), title = 'Patologies')
        ...
        layout.addWidget(sc,2,1)
        layout.addWidget(sc2,2,2)
        layout.addWidget(sc3,2,3)
        layout.addWidget(self.return_button,3,2)
